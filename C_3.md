...
There is a readable implementation of a semi-supervised GAN from the repository Improved GAN (Semi-supervised GAN). If
you'd like to implement this in code, I suggest reading through that code!
